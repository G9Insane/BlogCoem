...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blogonfire, BlogzoneViewHolder> FBRA = new FirebaseRecyclerAdapter<Blogonfire, BlogzoneViewHolder>(
                Blogonfire.class,
                R.layout.card_items,
            ...
            @Override
            protected void populateViewHolder(BlogzoneViewHolder viewHolder, Blogonfire model, int position) {
